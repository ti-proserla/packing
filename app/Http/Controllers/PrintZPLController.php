...
class PrintZPLController extends Controller
{
    ...
    public function muestra_etiqueta_caja(Request $request){
        ...
        $etiquetaCaja=EtiquetaCaja::select(
                        ...
                        'etiqueta_caja.*',
                        DB::raw("SUBSTRING(YEAR(LI.fecha_cosecha),-2,2) anio_cosecha"),
                        DB::raw("SUBSTRING(YEAR(etiqueta_caja.fecha_empaque),-2,2) anio_empaque"),
                        DB::raw("DAYOFYEAR(DATE_FORMAT(etiqueta_caja.fecha_empaque, '2016-%m-%d')) juliano_empaque"),
                        DB::raw("DAYOFYEAR(DATE_FORMAT(LI.fecha_cosecha, '2016-%m-%d')) juliano_cosecha"),
